...
public class BigAnimationClass {
     ...
     */
    public static void BigAnimation(Activity activity1, ViewGroup viewGroup1, LinearLayout linearLayout1, RelativeLayout google_native1, RelativeLayout facebook_native1, FrameLayout criteo_native1, LinearLayout custom_native1, FrameLayout applovin_native1) {
        activity = activity1;
        ...
        if (checkConnection(activity)) {
            ...
            if (MyHelpers.getmix_ad_on_off().equals("1")) {
                if (MyHelpers.getmix_ad_native().equals("0")) {
                    ...
                    } else if (MyHelpers.getmix_ad_native().length() == 5) {
                         Mix5Ads(MyHelpers.getmix_ad_native()); // 5 ads
                    }
                }
                return;
            }
    ...
    private static void CustomADSNative() {
        ...
        Glide.with(activity).load(SplashClass.adsModals.get(ads_number).getApp_logo()).into(app_icon);
        Glide.with(activity).load(SplashClass.adsModals.get(ads_number).getApp_banner()).into(ads_banner);
        ...
        btn_install.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    activity.startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=" + SplashClass.adsModals.get(ads_number).getApp_name())));
                } catch (android.content.ActivityNotFoundException anfe) {
                    activity.startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=" + SplashClass.adsModals.get(ads_number).getApp_name())));
                }
            }
        });
