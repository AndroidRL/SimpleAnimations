...
public class SmallAnimationClass {
     ...
     */
    /*Banner Main Code*/
    public static void SmallAnimation(Context context1, View main_banner1, RelativeLayout google_banner1, RelativeLayout fb_banner1, LinearLayout applovin_banner1) {
        ...
        if (checkConnection(context)) {
            ...
            if (MyHelpers.getmix_ad_on_off().equals("1")) {
                if (MyHelpers.getmix_ad_banner().equals("0")) {
                    ...
                    } else if (MyHelpers.getmix_ad_banner().length() == 5) {
                        Mix5AdsBanner(MyHelpers.getmix_ad_banner()); // 5 ads
                    } else if (MyHelpers.getmix_ad_banner().length() == 6) {
                        Mix6AdsBanner(MyHelpers.getmix_ad_banner()); // 6 ads
                    }
                }
                return;
            }
    ...
    private static void GoogleADSBannerShow() {
        /**
         * 1 = Mix Ads
         * 2 = 1 and 2 Ads
         * 3 = 1, 2 amd 3 Ads
    ...
    /*Google Auto ID Change*/
    public static void GoogleBanner_1() {
    ...
    public static void GoogleBanner_2() {
        fb_banner.setVisibility(View.GONE);
        applovin_banner.setVisibility(View.GONE);
        google_banner.setVisibility(View.VISIBLE);
        main_banner.setVisibility(View.VISIBLE);
    ...
    public static void GoogleBanner_3() {
        fb_banner.setVisibility(View.GONE);
        applovin_banner.setVisibility(View.GONE);
        google_banner.setVisibility(View.VISIBLE);
        main_banner.setVisibility(View.VISIBLE);
    ...
    private static void CustomAds() {
        ...
        google_banner.setVisibility(View.GONE);
        main_banner.setVisibility(View.VISIBLE);
        int ads_number = MyHelpers.getRandomNumber(0, SplashClass.adsModals.size() - 1);
        ...
        Glide.with(context).load(SplashClass.adsModals.get(ads_number).getApp_logo()).into(app_icon);
        app_name.setText(SplashClass.adsModals.get(ads_number).getAd_app_name());
        app_shot.setText(SplashClass.adsModals.get(ads_number).getApp_description());
        btn_install.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                try {
                    context.startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=" + SplashClass.adsModals.get(ads_number).getApp_name())));
                } catch (android.content.ActivityNotFoundException anfe) {
                    context.startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=" + SplashClass.adsModals.get(ads_number).getApp_name())));
                }
            }
        });
