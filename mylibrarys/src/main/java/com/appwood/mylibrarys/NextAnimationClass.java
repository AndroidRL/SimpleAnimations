...
public class NextAnimationClass {
     ...
     */
    public static void NextAnimation(Activity context, Intent intent, Integer ActivityFinish) {
         ...
         */
        if (NextAnimationClass.checkConnection(context)) {
            ...
            if (MyHelpers.getmix_ad_on_off().equals("1")) {
                if (MyHelpers.getmix_ad_inter().equals("0")) {
                    ...
                    }else if (MyHelpers.getmix_ad_inter().length() == 7) {
                        Mix7Ads(MyHelpers.getmix_ad_inter()); // 7 ads
                    }
                }
                return;
            }
...
//            }
    ...
    private static void Mix7Ads(String s) {
        char first_ads = s.charAt(0);
        char second_ads = s.charAt(1);
        char three_ads = s.charAt(2);
        char four_ads = s.charAt(3);
        ...
        if (mix_adsInter == 0) {
            ...
            mix_adsInter = 6;
            MixAdsShow(six_ads);
        }else if (mix_adsInter == 6) {
            mix_adsInter = 0;
            MixAdsShow(seven_ads);
        }
    }
